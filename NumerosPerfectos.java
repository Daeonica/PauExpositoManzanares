...
public class Ej05 {
     public static void main(String[] args) {
        ...
        for(num=1;perf <3;num++){      // num es el número que vamos a analizar para ver si es o no perfecto.
            //creamos un bucle for que tiene por condición parar cuando tengamos 3 números perfectos. Hasta entonces irá analizando números ya que en cada iteración a num le suma 1.
